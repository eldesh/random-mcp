/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 85f90d1cf46c0342a30fbbd02111bcd7)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_TOKEN" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY">> {}
}
declare module "*.css" {
	const value: string;
